...
namespace ScoringEngine.Client.Scoring.ScriptingBackends
{
    public class WindowsScriptBackend : IScriptBackend
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Interoperability", "CA1416:Validate platform compatibility", Justification = "Target requires Windows; Windows -> WindowsScriptProvider")]
